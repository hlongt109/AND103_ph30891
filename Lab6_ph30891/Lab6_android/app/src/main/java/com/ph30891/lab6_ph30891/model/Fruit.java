...
//    @SerializedName("id_distributor")
    ...
    public Fruit(String _id, String name, int quantity, double price, int status, ArrayList<String> image, String description, String distributorId) {
        this._id = _id;
        this.name = name;
    ...
    public Fruit setDistributorId(String distributorId) {
        this.distributorId = distributorId;
        return this;
    }
}
